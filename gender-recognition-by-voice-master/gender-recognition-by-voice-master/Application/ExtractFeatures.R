...
setwd("C:/VS code/gender-recognition-by-voice-master/gender-recognition-by-voice-master/data")

data = data.frame("A.wav", 0, 0, 20)
names(data) <- c('sound.files', 'selec', 'start', 'end')

acoustics <- specan3(data, parallel=1)
write.csv(acoustics, file = "Brian-Acoustics2.csv")
