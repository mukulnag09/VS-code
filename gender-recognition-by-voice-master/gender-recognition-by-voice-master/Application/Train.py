...
def runXGB(X, y):
    ...
    model.save_model('C:/VS code/gender-recognition-by-voice-master/gender-recognition-by-voice-master/Application/voice-gender2.model')

train_df = pd.read_csv('C:/VS code/gender-recognition-by-voice-master/gender-recognition-by-voice-master/Data/voice.csv')
